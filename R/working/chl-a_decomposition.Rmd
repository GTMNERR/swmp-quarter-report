...
```{r decomp, include = F}
decomp_pi <- data.frame(decomp.mult(chla_pi), date = as.Date(time(decomp.mult(chla_pi))))
summary(decomp.mult(chla_pi))

decomp_ss <- data.frame(decomp.mult(chla_ss), date = as.Date(time(decomp.mult(chla_ss))))
summary(decomp.mult(chla_ss))

decomp_fm <- data.frame(decomp.mult(chla_fm), date = as.Date(time(decomp.mult(chla_fm))))
summary(decomp.mult(chla_fm))

decomp_pc <- data.frame(decomp.mult(chla_pc), date = as.Date(time(decomp.mult(chla_pc))))
