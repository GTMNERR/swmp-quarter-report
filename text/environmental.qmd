...
MET |> 
  ...
  geom_hline(yintercept = 122, size = 2, linetype = "dashed", color = "grey50") +
...
MET |> 
  ...
  geom_segment(aes(x = date, xend = date, y = 0, yend = totprcp),
               size = 1) +
  geom_point(aes(color = wet), size = 4, bg = 4) +
