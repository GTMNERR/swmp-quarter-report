...
MET |> 
  ...
  geom_hline(yintercept = 81.4, linewidth = 2, linetype = "dashed", color = "grey50") +
  ...
  geom_text(aes(x = "Feb", y = 93), 
            label = "Current annual average: 81.4",
            size = 4.5,
            color = "grey50") +
  labs(x = '',
