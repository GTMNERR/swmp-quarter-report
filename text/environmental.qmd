...
The simplest way to bin rainfall within a single year is to present the data by quarter. Data is also presented as monthly totals and then daily totals as "rain days" which are categorized into Wet (\<10 mm), Very Wet (20-29 mm), and Extremely Wet (\>30 mm) days. 
