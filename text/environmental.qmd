...
Overall, there has currently been much less rain this year compared to previous years (@fig-rainfall-1). April had the highest amount of monthly rainfall (134 mm) from a Nor'easter and an extremely wet day later in the month (@fig-rainfall-2; @fig-rainfall-3). There were only 6 days of rain through mid-May that exceeded 20 mm of rainfall ("Very Wet") (@fig-rainfall-3). Additionally, the temperatures for both air and water were highly variable during this time with distinctive drops in temperature associated with the two Extremely Wet rain days in March and the end of April (@fig-rainfall-3; @fig-range-atemp; @fig-range-temp). All temperatures were higher than average from February through mid-March.

Nor'easters brought heavy rainfall in [March](https://www.weather.gov/bgm/pastWinterMarch142023) and in [April](https://flaglerlive.com/strong-noreaster-conditions-and-erosion-expected-on-easter-sunday-and-monday/) which raised salinity at all sites (@fig-range-sal), but was especially pronounced at Pellicer Creek (@fig-range-sal-4). The April Nor'easter had strong winds from the N and NE directions for almost an entire week (@fig-winds). As a result of the strong winds, increases in water depths (or water level for Pellicer Creek) were observed at all sites (@fig-range-depth).

![Weather Service Image from Flagler Live showing the wind speed predictions for the April Nor\'easter](/images/weather-service-easter.jpg) The conductivity sensor deployed at Fort Matanzas 04/04/2023-04/18/2023 had a conductivity sensor face issue (noted by Silas) with buildup and it looks like conductivity/salinity was affected. The observable drop in salinity in April at Fort Matanzas has not been quality checked and is likely due to the sensor failure (@fig-range-sal-3).

Another Nor'easter occurred [June 4-10,2023]().
...
MET |> 
  ...
  geom_hline(yintercept = 84.4, linewidth = 2, linetype = "dashed", color = "grey50") +
...
Air and water temperatures are presented as daily averages (blue line) with historic ranges (daily range and average daily range) provided in shades of gray. All temperature data uses data from 2002-2023. Additionally, due to news reports of extremely high temperatures in the summer months this year, a comparison was made of previous data for the months of June and July with average dew point (°F) and average air temperature (&deg;F) with total monthly precipitation (in). The greater the dew point, the greater the moisture in the air. 
...
#|    - "Comparison of average dew point and air temperature with total monthly precipitation for the months of June and July."
