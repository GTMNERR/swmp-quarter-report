...
Elevated chlorophyll *a* levels were observed at the three intracoastal waterway sites over several months this year (@fig-chla-boxplots). The levels were especially high at Pine Island from April through August (@fig-chla-boxplots-1); the highest observed chlorophyll in the entire time series was observed in April (18.5 $\mu$g/L). San Sebastian also had the highest chlorophyll observed in January and February of this year compared to the same months in all previous years (6.85 and 5.6 $\mu$g/L, respectively; @fig-chla-boxplots-2). High chlorophyll *a* at all stations in January are likely due to uncharacteristically high temperatures that month (@fig-range-temp).

Interestingly, though much higher seasonal chlorophyll was observed at Fort Matanzas in the first quarter, August was much lower than average (@fig-chla-boxplots-3). Values were much lower (some even below threshold levels) at all sites in the last quarter of the year.
...
Pine Island experienced an AGM chlorophyll value above the state threshold for the second time in the 19 year data set (@fig-chla-agm-1). The unusually high levels of chlorophyll in five months of the year likely contributed to this pattern. San Sebastian and Pellicer Creek continued to see high chlorophyll at those sites (@fig-chla-agm-2; @fig-chla-agm-4) and Fort Matanzas did not have high chlorophyll (@fig-chla-agm-3).
