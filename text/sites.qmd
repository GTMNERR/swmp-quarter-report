...
::: callout-note
All SWMP data are publicly available for download through the NERRS Centralized Data Management Office (CDMO). The CDMO supports data management protocols for SWMP and is responsible for ensuring that SWMP data are of high quality and accessible online (<https://nerrsdata.org>).
:::
