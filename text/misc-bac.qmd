...
DOC levels fell within historic range for most sites for the first quarter (@fig-doc-boxplots). Lower than average values were detected at San Sebastian in March (@fig-doc-boxplots-2) and below detection limit at Fort Matanzas for the same month (@fig-doc-boxplots-3).
